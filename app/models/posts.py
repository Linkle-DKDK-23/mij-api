...
class Posts(Base):
    ...
    ogp_storage_key: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    video_storage_key: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    sample_video_storage_key: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    video_duration: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True)
    sample_video_duration: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True)
